	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<div class="row-fluid">
					<div class="span12" style="border-radius: 3px;width:99%; border:1px solid #EEEEEE;padding:10px;margin-bottom: 20px">
						<label style="margin-top: 15px;color: red;display: inline;" id="sum"></label>&nbsp;&nbsp;<button class="btn btn-warning" onclick="saveImg();" id="saveImg" data-toggle="modal" data-target="#myModal">生成图片</button>
						...
						drawPieChart("<c:url value='/chart/studentMajor' />",null);
						</script>
					</div>
				</div>
			</div>
