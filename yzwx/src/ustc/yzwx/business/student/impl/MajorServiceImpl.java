...
public class MajorServiceImpl implements MajorService {
	...
	@Override
	public List<Major> getParentMajor() {
		return majorDao.getParentMajor();
	}
	...
	@Override
	public Major selectByMajorCode(String majorCode) {
		return majorDao.selectByMajorCode(majorCode);
	}
