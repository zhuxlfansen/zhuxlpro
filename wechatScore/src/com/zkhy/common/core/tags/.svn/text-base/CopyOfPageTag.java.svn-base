package com.zkhy.common.core.tags;
...
public class CopyOfPageTag extends SimpleTagSupport {
	private int curPage;
	private int count;
	private int pageCount;
	private String url;
	private String pagingFnc;
	...
	public void doTag() throws JspException, IOException {
		...
		out.write("\r\n");
		if(StringUtils.isEmpty(pagingFnc)) {
			...
			out.write("<p>第<strong>"+curPage+"</strong>页<strong>"+"</strong>共<strong>"+pageCount+"</strong>页<strong>"+count+"</strong>条记录&nbsp;&nbsp;转到第<input type=\"text\" class=\"TxtInp\" value=\""+curPage+"\" name=\"curPage\" id=\"curPage\"/>页<input type=\"button\" class=\"goTo\" value=\"go\" name=\"\" class=\"Btn\" onclick=\""+pagingFnc+"("+pageCount+");\" /></p>");
		}
		...
		if(StringUtils.isEmpty(pagingFnc)) {
			...
			out.write("<li><a href=\"javascript:"+pagingFnc+"(1,"+pageCount+");\" title=\"第一页\">&lt;&lt;</a></li>");
		}
		...
		if(StringUtils.isEmpty(pagingFnc)) {
			...
			out.write("<li><a href=\"javascript:"+pagingFnc+"("+(curPage-1)+","+pageCount+");\" title=\"上一页\">&lt;</a></li>");
		}
...
//		out.write("\r\n");
		...
		if(StringUtils.isEmpty(pagingFnc)) {
			...
			out.write("<li><a href=\"javascript:"+pagingFnc+"("+(curPage+1)+","+pageCount+");\" title=\"下一页\">&gt;</a></li>");
		}
		...
		if(StringUtils.isEmpty(pagingFnc)) {
			...
			out.write("<li><a href=\"javascript:"+pagingFnc+"("+pageCount+","+pageCount+");\" title=\"末页\">&gt;&gt;</a></li>");
		}
		...
		for(int i=beginNum;i<=endNum;i++){
			if(i==curPage){
				if(StringUtils.isEmpty(pagingFnc)) {
					...
					out.write("<li><a href=\"javascript:"+pagingFnc+"("+i+","+pageCount+");\" title=\""+i+"\" class=\"ExtLoopLink\">"+i+"</a></li>");
				}
				...
				if(StringUtils.isEmpty(pagingFnc)) {
					...
					out.write("<li><a href=\"javascript:"+pagingFnc+"("+i+","+pageCount+");\" title=\""+i+"\">"+i+"</a></li>");
				}
	...
	public String getPagingFnc() {
		return pagingFnc;
	}


	public void setPagingFnc(String pagingFnc) {
		this.pagingFnc = pagingFnc;
	}
