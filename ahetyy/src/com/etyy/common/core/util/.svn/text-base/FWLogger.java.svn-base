...
import ustc.yzwx.common.core.i18n.I18nCode;
import ustc.yzwx.common.core.i18n.I18nMessage;
import ustc.yzwx.common.core.i18n.I18nMessageAccessor;
...
public class FWLogger {
     ...
     * INFO message输出
     *
     * @param code MessageResourcesLog中设定的messageCode (例:errors.e0002)
     ...
     *
     * @param msgId MessageResourcesLog中设定的messageCode (例:errors.e0002)
