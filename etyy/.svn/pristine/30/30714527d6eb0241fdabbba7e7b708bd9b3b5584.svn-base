...
import ustc.etyy.wechat.bean.SNSUserInfo;
import ustc.etyy.wechat.bean.WeixinOauth2Token;
import ustc.etyy.wechat.bean.WeixinUserInfo;
...
public class AdvancedUtil {
	...
	public static String getQRCode(String ticket,String savePath,String sceneId){
		...
		//拼接请求地址
		String requestUrl =WeChatConfig.getProperty("wechat_showqurcode_url")+"TICKET";
