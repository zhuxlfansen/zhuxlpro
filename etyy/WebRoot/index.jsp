...
<body class="easyui-layout" style="margin:0px 1px 0px 1px;">
		...
		-->
		<div data-options="region:'north'" style="height:82px;background:url(static/commonJS/je/css/images/header-backg_02.png);">
			<img src="static/commonJS/je/css/images/zLogo_03.png" style="float:left; margin-top:18px; margin-left:13px;"/>
			<div class="sp_font"><img src="static/commonJS/je/css/images/people_03.png" style="margin-top:-4px; padding-left:15px;"/></div>
			<div class="sp_font">欢迎您&nbsp;:</div>
			<div class="sp_font">admin</div>
			<div class="sp_font"><img src="static/commonJS/je/css/images/mail_03.png" style="margin-top:-4px; padding-left:10px;"/></div>
			...
			<div class="sp_font" style="float:right;margin-right:0px;">
				<img src="static/commonJS/je/css/images/clock_03.png" style="margin-top:-4px;"/>
			</div>
		</div>
		
		<div id="footer" data-options="region:'south',split:false" style="height:30px;background:url(static/commonJS/je/css/images/footbackg_03.png);">
			By 中科瀚云
		</div>
		<div data-options="region:'west',split:false" title="主菜单" class="menu_item">
			<div class="easyui-accordion" data-options="fit:true,border:false">
				<div title="预约管理" data-options="selected:true">
					<ul>
						<li ><a href="javascript:void(0)" onClick="openMenu('work/schedulingList');">排班管理</a></li>
						<li><a href="javascript:void(0)" onClick="openMenu('work/queryOrderList');">预约挂号查询</a></li>
						<li><a href="javascript:void(0)" onClick="openMenu('work/schedulingTable');">排班表</a></li>
						<li><a href="javascript:void(0)" onClick="openMenu('work/order');">预约挂号</a></li>
					</ul>
				</div>
				<!-- <div title="模型管理">
					<ul>
		...
		<div data-options="region:'center',title:'主界面',iconCls:'icon-tip'" style="overflow-x:hidden">
			...
			-->	
			<iframe id="iframe_center" name="iframe_center" width="100%" height="99%" frameborder=no src="" scrolling="auto"></iframe>
		</div>
</body>
</html>
